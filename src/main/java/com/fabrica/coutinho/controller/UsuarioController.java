...
public class UsuarioController {
	...
	public UsuarioVO findById(@PathVariable("id")  Integer id) {
	...
	public UsuarioVO create(@RequestBody UsuarioVO usuarioVO) {
		UsuarioVO vo = usuarioService.create(usuarioVO);
		vo.add(linkTo(methodOn(UsuarioController.class).findById(vo.getId())).withSelfRel());
		return vo;
	}
	...
	public UsuarioVO update(@RequestBody UsuarioVO usuarioVO) {
		UsuarioVO vo = usuarioService.update(usuarioVO);
		vo.add(linkTo(methodOn(UsuarioController.class).findById(usuarioVO.getId())).withSelfRel());
		return vo;
	}
